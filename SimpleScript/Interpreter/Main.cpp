...
KataScript::IkigaiScriptInterpreter interp(KataScript::ModulePrivilege::allPrivilege);
...
void integrationExample() {
    ...
    interp.newClass("beansClass", { {"color", std::make_shared<KataScript::Value>("white")} },
        ...
        [](KataScript::Class* classs, KataScript::ScopePtr scope, const KataScript::List& vars) {
            if (vars.size() > 0) {
        ...
        {
        {"changeColor", [](KataScript::Class* classs, KataScript::ScopePtr scope, const KataScript::List& vars) {
            if (vars.size() > 0) {
                interp.resolveVariable("color", classs, scope) = vars[0];
            }
            return std::make_shared<KataScript::Value>();
            } },
        {"isRipe", [](KataScript::Class* classs, KataScript::ScopePtr scope, const KataScript::List&) {
